...
export default class MineHistoryMsg extends Component {
    ...
    async _fetchListData() {
        const url = 'http://121.11.71.33:8081/api/msg/user?page=' + this.page + '&is_read=1';
                ...
                <View style={{ flexDirection: 'row', height: 45, paddingHorizontal: 12, alignItems: 'center', backgroundColor: '#03c893', justifyContent: 'space-between' }}>
                    <TouchableHighlight underlayColor="rgba(0,0,0,0)" onPress={() => { this.props.navigation.goBack(null); }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ color: '#fff', fontSize: 16, marginLeft: 7 }}>历史消息</Text>
                        </View>
                    </TouchableHighlight>
                </View>
                {body}
