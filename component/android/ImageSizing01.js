...
export default class ImageSizing01 extends Component {
    ...
    componentDidMount() {
        DefaultImage.getSize(this.props.uri, (width, height) => {
    ...
    render() {
        ...
        return <Image source={{ uri: this.props.uri }} style={{ width: width, height: height }} />;
    }
}