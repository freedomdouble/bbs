...
export default class User extends Component {
    ...
    async _updateRowData() {
        ...
        if (result.status == 1) {
            this.dynamicObject.list[this.state.rowId].comments = result.dynamic.comments;
            this.dynamicObject.list[this.state.rowId].comment_account = result.dynamic.comment_account;
            ...
            this.setState({ dynamicObject: dynamicObject, visible: !this.state.visible });
        }
    }
